...
When perform fuzzing on wasm, there are two-dimensional input spaces. One is `.js` file. Another is `.wasm` file.

We provide a [fuzzing driver](https://github.com/wcventure/WasmFuzz/tree/master/WasmFuzz/Fuzzing) to mutate both `.js` file and `.wasm` file.
...
To efficiently perform fuzzing on wasm, I suggest that you can use Skyfire to generate Seed input.
You can also use Superion, recent progress, to perform fuzzing on wasm.

- Skyfire: [https://github.com/zhunki/Skyfire](https://github.com/zhunki/Skyfire)
- Superion: [https://github.com/zhunki/Superion](https://github.com/zhunki/Superion)
...
### 3.2 Superion (Improved by zhunki, Integrated into AFL)
